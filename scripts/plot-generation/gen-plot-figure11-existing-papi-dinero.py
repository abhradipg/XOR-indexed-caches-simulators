...
FIG_HEIGHT = 5.5
FIG_WIDTH = 8
plot_file = "{}/figure11-{}-papi-accuracy-l1.pdf".format(plots_path, dataset).replace(".pdf", "-existing-papi-dinero.pdf")
...
DINERO_MISS_CSV = "{}/miss/dinero-{}-l1-l2.csv".format(data_path, dataset).replace("reproduced", "existing")
PAPI_MISS_CSV = "{}/miss/papi-{}-o2.csv".format(data_path, dataset).replace("reproduced", "existing")
