...
int main(int argc, const char **args) {
...

  {
...
#ifdef ONE_CACHE
    machine_model MachineModel = {CACHE_LINE_SIZE, {CACHE_SIZE1}};
#elif THREE_CACHES
    machine_model MachineModel = {CACHE_LINE_SIZE, {CACHE_SIZE1, CACHE_SIZE2, CACHE_SIZE3}};
#elif POLY_CACHE
    machine_model MachineModel = {CACHE_LINE_SIZE, {32 * 1024, 256 * 1024}}; // poly cache cache sizes
#else
    ...
    CacheModel Model(Context, MachineModel);
