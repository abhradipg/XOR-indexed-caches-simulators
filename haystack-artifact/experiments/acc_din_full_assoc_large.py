...
OUTPUT = "./data/polybench_large/acc_din_full_assoc_O2.csv"
ITERATIONS = 1

DINERO_ARGS = "-l1-dsize 32768 -l1-dbsize 64 -l1-dassoc 512 -l1-dccc -l2-dsize 1048576 -l2-dbsize 64 -l2-dassoc 16384 -l2-dccc"
