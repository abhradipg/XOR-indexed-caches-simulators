...
DINERO_ARGS = "-l1-dsize 32768 -l1-dbsize 64 -l1-dassoc 2 -l1-dccc -l1-drepl l -l2-dsize 524288 -l2-dbsize 64 -l2-dassoc 8 -l2-dccc -l2-drepl l -l3-dsize 4194304 -l3-dbsize 64 -l3-dassoc 16 -l3-dccc -l3-drepl l"
