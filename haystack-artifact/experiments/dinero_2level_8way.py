...
BINARY = "./executables/2level/8way/"
OUTPUT = "./data/polybench_large/2level_8way.csv"
ITERATIONS = 1

DINERO_ARGS = "-l1-dsize 32768 -l1-dbsize 64 -l1-dassoc 8 -l1-dccc -l1-drepl l -l2-dsize 1048576 -l2-dbsize 64 -l2-dassoc 8 -l2-dccc -l2-drepl l"
